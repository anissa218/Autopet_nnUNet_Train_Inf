...
path_to_results219="nnUNet_results/Dataset219_PETCT/nnUNetTrainer_1500epochs_1e2lr__nnUNetPlans__3d_fullres/crossval_results_folds_0_1_2/postprocessed/summary.json"
...
df.to_csv('e-219-CV-results.csv')

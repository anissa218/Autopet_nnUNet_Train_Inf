...
# run inference
#nnUNetv2_predict -d Dataset219_PETCT -i nnUnet_raw/Dataset220_PETCT/imagesTs -o nnUNet_results/Dataset219_PETCT/nnUNetTrainer_probabilisticOversampling_033__nnUNetPlans__3d_fullres/inferTs -f  0 1 2 3 4 -tr nnUNetTrainer_probabilisticOversampling_033 -c 3d_fullres -p nnUNetPlans

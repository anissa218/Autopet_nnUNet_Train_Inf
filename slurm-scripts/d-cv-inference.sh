...
#nnUNetv2_find_best_configuration 219 -c 3d_fullres_maxnum_512_patch_192 -tr nnUNetTrainer -f 0 1 2
...
python d-calc-metrics-cv.py

#submit with: sbatch -p gpu_long --gres gpu:1 d-cv-inference.sh

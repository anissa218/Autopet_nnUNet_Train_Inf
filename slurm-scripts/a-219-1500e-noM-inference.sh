...
nnUNetv2_predict -d Dataset219_PETCT -i nnUnet_raw/Dataset222_PETCT/imagesTs -o nnUNet_results/Dataset219_PETCT/nnUNetTrainer_1500epochs_NoMirroring__nnUNetPlans__3d_fullres/inferTs222 -f  0 1 2 3 4 -tr nnUNetTrainer_1500epochs_NoMirroring -c 3d_fullres -p nnUNetPlans

...
nnUNetv2_train 219 3d_fullres_maxnum_512_patch_192 0 -tr nnUNetTrainer_1500epochs_1e2lr --npz -device cuda --c #0 is which of 5 CV folds is trained



#submit with: sbatch -p gpu_long --gres gpu:1 0-219-1500e-max512-patch192-nnunet.sh
# sleep 300s

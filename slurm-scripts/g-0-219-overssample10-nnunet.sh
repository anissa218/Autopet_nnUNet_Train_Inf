...
nnUNetv2_train 219 3d_fullres 0 -tr nnUNetTrainer_probabilisticOversampling_010 --npz -device cuda --c #0 is which of 5 CV folds is trained



#submit with: sbatch -p gpu_long --gres gpu:1 g-0-219-overssample10-nnunet.sh

...
nnUNetv2_train 219 3d_fullres_maxnum_512_patch_192 4 -tr nnUNetTrainer_1500epochs_1e2lr --npz -device cuda --c #0 is which of 5 CV folds is trained



#submit with: sbatch -p gpu_long --gres gpu:1 c-0-219-1500e-max512-patch192-1e2lr-nnunet.sh

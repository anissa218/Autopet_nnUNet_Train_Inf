...
nnUNetv2_plan_and_preprocess -d 218 -c 3d_fullres --verify_dataset_integrity

#nnUNetv2_train 218 3d_fullres 0 --npz -device cuda #0 is which of 5 CV folds is trained




#submit with: sbatch -p gpu_long --gres gpu:1 preprocess-nnunet-1.sh
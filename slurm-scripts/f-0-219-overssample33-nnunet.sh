...
nnUNetv2_train 219 3d_fullres 0 -tr nnUNetTrainer_probabilisticOversampling_033 --npz -device cuda --c #0 is which of 5 CV folds is trained



#submit with: sbatch -p gpu_long --gres gpu:1 e-0-219-1500e-1e2lr-nnunet.sh

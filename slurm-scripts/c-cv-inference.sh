...
nnUNetv2_find_best_configuration 219 -c 3d_fullres_maxnum_512_patch_192 -tr nnUNetTrainer_1500epochs_1e2lr -f 0 1 2 3 4

# run inference
nnUNetv2_predict -d Dataset219_PETCT -i nnUnet_raw/Dataset220_PETCT/imagesTs -o nnUNet_results/Dataset219_PETCT/nnUNetTrainer_1500epochs_1e2lr__nnUNetPlans__3d_fullres_maxnum_512_patch_192/inferTs -f  0 1 2 3 4 -tr nnUNetTrainer_1500epochs_1e2lr -c 3d_fullres_maxnum_512_patch_192 -p nnUNetPlans
